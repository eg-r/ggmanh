...
#' Additional options, such as chromosome color, label columnames,
...
manhattan_plot <- function(
  ...
  UseMethod("manhattan_plot", x)
}

#' @rdname manhattan_plot
#' @export
manhattan_plot.default <- function(x, ...) {
  stop("Provide a data.frame to preprocess & plot or a preprocessed MPdata object.")
}
...
#' @inheritParams manhattan_plot.MPdata
#'
#' @export
